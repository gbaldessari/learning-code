...
public class VentanaSeleccionRobotPieza extends JFrame {
	private static final long serialVersionUID = 13;
	AdministradorVentanas administradorVentanas;
	Sistema sistema;
	public VentanaSeleccionRobotPieza (AdministradorVentanas administradorVentanas,Sistema sistema) {
	...
	private void IniciarComponentes() {
        ...
        if(sistema.getListaRobots().length!=0) {
			...
			botonSiguiente.addActionListener(new ActionListener() {@Override public void actionPerformed(ActionEvent e) {administradorVentanas.cambiarPiezas(administradorVentanas, index);setVisible(false);}});
        }
